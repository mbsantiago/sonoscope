...
import { WEBGL2_DITHER_FRAGMENT_SHADER, WEBGL2_FRAGMENT_SHADER, WEBGL2_TERRAIN_FRAGMENT_SHADER, WEBGL2_TERRAIN_VERTEX_SHADER, WEBGL2_VERTEX_SHADER, WebGL2SpectrogramRenderer } from './webgl2';
