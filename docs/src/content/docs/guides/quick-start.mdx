...
Use [`Sonoscope`](/sonoscope/reference/core/classes/sonoscope/) to manage audio loading and attach visualization viewers.
...
Wrap viewers with [`SonoscopeProvider`](/sonoscope/reference/react/variables/sonoscopeprovider/) and compose [`TimeRuler`](/sonoscope/reference/react/variables/timeruler/), [`Spectrogram`](/sonoscope/reference/react/variables/spectrogram/), and [`Waveform`](/sonoscope/reference/react/variables/waveform/).
