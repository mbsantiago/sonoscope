...
<SpectrogramPreview config={{ minValue: -60, maxValue: -10 }} />

### 7. Halftone shader effect
Renders with a retro halftone shader program:
...
<SpectrogramPreview config={{ renderer: "halftone", minValue: -120, maxValue: -40 }} />
