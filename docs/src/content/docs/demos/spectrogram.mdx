...
<SpectrogramPreview config={{ colorMap: "inferno", minDb: -80, maxDb: 0 }} />
...
<SpectrogramPreview config={{ minDb: -60, maxDb: -10 }} />
...
<SpectrogramPreview config={{ colorMap: "plasma", minDb: -85, maxDb: 0 }} />

> For stylized shader programs and alternative renderers (Halftone, 3D Terrain, Topographic, ASCII), see the [Plugins](/sonoscope/plugins/) section.
