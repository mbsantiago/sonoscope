...
### 7. Halftone shader effect
Renders with a retro halftone shader program plugin (`@sonoscope/halftone-spectrogram`):
...
<SpectrogramPreview config={{ renderer: "halftone", minDb: -120, maxDb: -40 }} />
