...
<PluginSpectrogramPreview config={{ renderer: "ascii", rendererOptions: { colorMode: "green", fontSize: 10 }, frequencyScale: "mel" }} />
...
<PluginSpectrogramPreview config={{ renderer: "halftone", minDb: -100, maxDb: -30, frequencyScale: "mel" }} />
...
<PluginSpectrogramPreview config={{ renderer: "terrain", frequencyScale: "mel" }} />
...
<PluginSpectrogramPreview config={{ renderer: "topographic", minDb: -100, maxDb: -30, frequencyScale: "mel" }} />
